...
class _BillingTabState extends State<BillingTab> with TickerProviderStateMixin {
  ...
  // Widget _buildCartItem(SaleItem item, Product product, int index) {
  ...
  //                           ),
  //                           Text(
  //                             'Available: ${availableStock.toStringAsFixed(product.unit == UnitType.kg ? 1 : 0)} ${product.unit.name}',
  //                             style: TextStyle(
  //                               color: availableStock <= 0 ? _errorColor : _textSecondary,
  //                               fontSize: 12,
  //                             ),
  //                           ),
  //                         ],
  ...
  //                             ),
  //                             IconButton(
  //                               onPressed: availableStock >= increment ? () {
  //                                 setState(() {
  //                                   item.qty += increment;
  //                                 });
  //                               } : null,
  ...
  //                                 Icons.add, 
  //                                 size: 18,
  //                                 color: availableStock >= increment ? null : Colors.grey,
  //                               ),
  //                               constraints: const BoxConstraints(minWidth: 36, minHeight: 36),
  //                             ),
  //                           ],
